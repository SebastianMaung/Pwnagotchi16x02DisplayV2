...
I let it run for about an hour and it didn't have any weird screen glitch issue like my old version.
...
I know, it feels wrong, but I couldn't find an easier way, so I re-used the script from the old version
...
A simple and sketchy way is to go to your plugins and just add an 'os.system("python3 /path/to/1602.py &")' somewhere good
